...
export const SignUp = (props) => {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      await axios({ method: "post", url: `${SIGNUP_ROUTE}`, data: { name, email, password } });
  ...
  return (
    <>
      <div className="container ">
        <div className="login-wrapper flex flex--column gap--md align-items--c" style={signupPageStyle}>
          <h2>Sign Up</h2>
          <Formik initialValues={initialValues} validationSchema={signupValidationSchema} onSubmit={onSubmit}>
            <Form className="mt-1 w--50% flex flex--column align-items--c justify-content--c gap--sm">
              ...
              <div className="form-group">
                <Field type="text" name="name" className="form-control border-radius--sm p--xs" placeholder="Name" />
              ...
              <Btn type="submit" size="xs" variant="primary" className="border-radius--sm  w--100% p--0 p--xxs--xs">
                signup
              </Btn>
            </Form>
          </Formik>
